...
|---------------------|---------------------|--------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | *Binda Arbañil, Marcelo Alejandro*: Entrevistas, análisis competitivo, antecedentes y problemática, style guidelines, landing page UI design, web applications UI design. | El equipo demostró liderazgo conjunto al dividir responsabilidades estratégicamente según fortalezas individuales, como análisis, investigación de mercado o validación con usuarios. La ejecución de entrevistas y los mapeos de escenarios requirieron coordinación y toma de decisiones colaborativas, fomentando un liderazgo compartido en todas las fases de diagnóstico del problema y definición de oportunidades. Esta sinergia permitió mantener una visión alineada y centrada en el usuario desde múltiples frentes del proyecto. |
|  | *Castillo Garay, Ainhoa Lucía*: Entrevistas, style guidelines, landing page UI design, web applications UI design. | La colaboración efectiva fue esencial para alinear la visión del proyecto entre todos los integrantes. Un liderazgo compartido permitió que las discusiones y la planificación inicial se enriquecieran con diversas perspectivas, asegurando así una base sólida y un entendimiento común de los objetivos desde el comienzo. |
...
| Criterio específico | Acciones realizadas | Conclusiones |
|---------------------|---------------------|--------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | *Binda Arbañil, Marcelo Alejandro*: Implementación de sección de organización, actividades y traducciones con i18n. | Mejoré mi habilidad para exponer ideas técnicas de manera clara y organizada, adaptándome a la audiencia y respondiendo preguntas con confianza. |
|  | *Castillo Garay, Ainhoa Lucía*: Implementación de sección de certificados y participaciones. | Fortalecí mi capacidad para comunicar oralmente estructurando intervenciones comprensibles y efectivas. |
|  | *Martel Andrade, Cassius Estefano*: Implementación de secciones de voluntarios e inscripciones. | Perfeccioné mi expresión oral al presentar con seguridad y claridad aspectos técnicos y responder preguntas. |
|  | *Nakamurakare Teruya, Alex Tomio*: Expuse con claridad contenidos técnicos y participé activamente en discusiones. |
|  | *Ortiz Alarcón, Víctor Nicolás*: Desarrollé habilidades para adaptarme a diferentes audiencias y responder preguntas con precisión. |
|  | *Galván Cerrón, George Aldo*: Pasé el documento a markdown y realice el canva para exponer. | Fortalecí mi comunicación oral al presentar ideas de forma clara y estructurada e interactuar con la audiencia. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | *Binda Arbañil, Marcelo Alejandro* | En esta entrega, siento que contribuí significativamente a la claridad y precisión de nuestra documentación técnica. Logré refinar la redacción de los documentos, asegurando que fueran coherentes y fáciles de entender. Creo que esto fue crucial para que la información compleja se comunicara de manera efectiva a todo el equipo y a las partes interesadas. |
|  | *Castillo Garay, Ainhoa Lucía* | Estoy satisfecha con la calidad de los textos técnicos que redacté. Mi objetivo era hacer que la información fuera accesible y estuviera bien estructurada, y siento que lo conseguimos. La organización clara de las ideas fue clave para facilitar la comprensión de nuestro trabajo y avances. |
|  | *Martel Andrade, Cassius Estefano* | Considero que mejoré considerablemente la forma en que presentamos nuestros informes. Me enfoqué en que los resultados se mostraran de manera ordenada y profesional, lo que, en mi opinión, hizo que el seguimiento del proyecto fuera mucho más eficiente y visualmente atractivo. |
|  | *Nakamurakare Teruya, Alex Tomio* | Pienso que mi trabajo en la documentación técnica fue fundamental para mantener al equipo y a los interesados informados. Me esforcé por asegurar que la información fuera clara y coherente, lo que permitió una transmisión fluida y efectiva del progreso del proyecto. |
|  | *Ortiz Alarcón, Víctor Nicolás* | En esta entrega, me centré en crear documentos técnicos que fueran realmente comprensibles. Siento que esto facilitó enormemente la presentación de nuestro trabajo, permitiendo que todos entendieran rápidamente lo que habíamos logrado y cómo. |
|  | *Galván Cerrón, George Aldo* | Para mí, lo más destacable fue aprender a estructurar y redactar documentos técnicos con precisión. Esta habilidad me permitió contribuir a una mejor organización general del proyecto, y siento que la calidad de nuestra documentación se elevó gracias a ello. |
...
| Criterio específico | Acciones realizadas | Conclusiones |
|---------------------|---------------------|--------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | *Binda Arbañil, Marcelo Alejandro*: Desarrollo de Notifications y Activity-Registration bounded context. | Mi enfoque en el desarrollo de los bounded contexts de Notificaciones y Actividad-Registro me permitió ejercer un liderazgo técnico fundamental. Al ser el principal responsable de estas áreas, aseguré que las decisiones de diseño y la implementación fueran coherentes con la arquitectura general del proyecto, facilitando la integración con el trabajo de mis compañeros y manteniendo una visión unificada. |
|  | *Castillo Garay, Ainhoa Lucía*: Desarrollo del Sprint 3. | Al liderar el desarrollo del Sprint 3, asumí la responsabilidad de coordinar y unificar los esfuerzos del equipo en esta fase crucial. Mi rol implicó asegurar que las tareas estuvieran alineadas con los objetivos del sprint y que los avances individuales convergieran en un producto cohesivo, demostrando un liderazgo proactivo en la gestión del flujo de trabajo. |
|  | *Martel Andrade, Cassius Estefano*: Desarrollo de Participations y Volunteer-Registration bounded context. | La creación de los bounded contexts de Participaciones y Registro de Voluntarios me posicionó como un referente clave en esas áreas. Esto implicó una toma de decisiones constante y la guía para asegurar que estos módulos no solo funcionaran correctamente, sino que también se integraran sin problemas con el resto del sistema, mostrando un liderazgo especializado y enfocado. |
|  | *Nakamurakare Teruya, Alex Tomio*: Desarrollo del Validation Interview. | Mi participación en el desarrollo de la Entrevista de Validación fue una oportunidad para ejercer un liderazgo basado en la investigación y el análisis. Al frente de este proceso, aseguré que las preguntas y el enfoque nos proporcionaran los insights necesarios, guiando al equipo en la dirección correcta para entender las necesidades del usuario y validar nuestras hipótesis. |
|  | *Ortiz Alarcón, Víctor Nicolás*: Desarrollo del Sprint 3. | Como parte del liderazgo en el desarrollo del Sprint 3, mi contribución principal fue asegurar la implementación efectiva de las funcionalidades asignadas, sirviendo como un punto de apoyo técnico para el resto del equipo. Mi enfoque estuvo en desatascar problemas y garantizar que los avances individuales se tradujeran en un progreso tangible del sprint, mostrando un liderazgo orientado a la ejecución y resolución. |
|  | *Galván Cerrón, George Aldo*: Realizo el deployment y el markdown. | La responsabilidad del deployment y la creación del markdown me permitió ejercer un liderazgo vital en la fase de entrega y documentación. Aseguré que el producto final estuviera correctamente desplegado y que toda la información relevante estuviera clara y accesible, asumiendo un rol crucial en la visibilidad y accesibilidad del proyecto. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | *Binda Arbañil, Marcelo Alejandro* | Durante el desarrollo de Notificaciones y Actividad-Registro, mi prioridad fue mantener una comunicación abierta para integrar las sugerencias de mis compañeros. Me aseguré de que las metas de mis módulos estuvieran claras y que mi trabajo facilitara la colaboración, creando un ambiente donde todos se sentían parte de la solución y podíamos cumplir nuestros objetivos como equipo. |
|  | *Castillo Garay, Ainhoa Lucía* | En el Sprint 3, mi rol fue clave para fomentar un entorno donde cada voz era escuchada. Nos aseguramos de que las metas fueran compartidas y las tareas distribuidas de manera justa, lo que nos permitió mantenernos en el camino correcto y alcanzar nuestros objetivos de forma eficiente. Fue gratificante ver cómo la colaboración llevó al éxito de este sprint. |
|  | *Martel Andrade, Cassius Estefano* | Al construir los bounded contexts de Participaciones y Registro de Voluntarios, promoví activamente la retroalimentación constante y la toma de decisiones conjunta. Establecimos micro-metas claras para cada funcionalidad y las planificamos detalladamente, lo que nos ayudó a cumplir con los entregables a tiempo y a construir un sistema robusto mediante un esfuerzo colectivo. |
|  | *Nakamurakare Teruya, Alex Tomio* | Mi labor en la Entrevista de Validación fue un ejercicio de colaboración total. Fomenté un espacio donde las ideas fluían libremente, planificamos cada paso de la entrevista para obtener la mejor información y nos aseguramos de que los resultados se usaran para establecer objetivos realistas y alcanzables. Este proceso colaborativo fue clave para validar nuestra dirección. |
|  | *Ortiz Alarcón, Víctor Nicolás* | En el Sprint 3, mi contribución se centró en asegurar que las tareas estuvieran claramente definidas y planificadas para cada miembro. Trabajamos juntos para resolver cualquier obstáculo y celebrar los pequeños logros, lo que fortaleció el sentido de equipo y nos impulsó a cumplir con todos los objetivos del sprint. Fue un esfuerzo coordinado para lograr el éxito. |
|  | *Galván Cerrón, George Aldo* | Mi rol en el deployment y la documentación en markdown fue el de conectar el desarrollo con la entrega final. Al hacerlo, me aseguré de que el proceso fuera transparente y que todos tuvieran acceso a la información necesaria. Esto ayudó a unificar los esfuerzos del equipo hacia un objetivo común: un producto bien presentado y funcional, demostrando que con planificación se logran los objetivos. |
...
| Criterio específico | Acciones realizadas | Conclusiones |
|---------------------|---------------------|--------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | *Binda Arbañil, Marcelo Alejandro*: Desarrollo del Sprint 4. | Durante el Sprint 4, asumí el liderazgo en la elaboración del documento final, estructurando y redactando los contenidos clave para representar el trabajo del equipo de forma clara y coherente. Este rol implicó coordinar con todos los miembros para integrar sus aportes, verificar la precisión de la información técnica y asegurar que el documento reflejara fielmente nuestra visión y logros del sprint. Mi liderazgo se centró en la organización de ideas, la consistencia narrativa y la presentación efectiva del proyecto. |
|  | *Castillo Garay, Ainhoa Lucía*: Conexión entre el frontend y backend de los voluntarios. | Contribuí activamente a los avances técnicos del Sprint 4, asegurando la correcta integración de las funcionalidades en el flujo general de la plataforma. Mi enfoque estuvo en mantener la cohesión entre los módulos trabajados por el equipo, así como en brindar apoyo técnico y revisiones colaborativas. Este rol me permitió ejercer un liderazgo técnico que fomentó la calidad del código y la alineación del trabajo entre los integrantes. |
|  | *Martel Andrade, Cassius Estefano*: Conexión entre el frontend y backend de las notificaciones e implementación de tokens. | En este sprint, enfoqué mi liderazgo en asegurar que los módulos bajo mi responsabilidad estuvieran correctamente integrados con el resto del sistema. Realicé validaciones cruzadas, pruebas funcionales y colaboración estrecha con mis compañeros para resolver conflictos e inconsistencias. Aporté también en la revisión final del documento, lo que permitió asegurar una visión integral y cohesionada del trabajo realizado. |
|  | *Nakamurakare Teruya, Alex Tomio*: Conexión entre el frontend y backend del dashboard, voluntarios inscritos y el calendario. | Mi aporte principal durante este sprint fue garantizar la validación funcional de las tareas desarrolladas y colaborar en la consolidación del documento. Participé activamente en las revisiones cruzadas y validé los flujos de usuario propuestos, contribuyendo a que los entregables cumplieran con las expectativas planteadas. Mi rol ayudó a mantener la consistencia funcional de VolunTrack. |
|  | *Ortiz Alarcón, Víctor Nicolás*: Conexión entre el frontend y backend de los certificados. | Durante este sprint, asumí tareas clave para cerrar el desarrollo técnico de funcionalidades pendientes, apoyando también en los procesos de documentación y verificación final. Fui un punto de apoyo para destrabar dificultades técnicas y asegurar que el producto final reflejara el esfuerzo colectivo del equipo, cumpliendo con los objetivos del Sprint 4. |
|  | *Galván Cerrón, George Aldo*: Internacionalización y validaciones en el backend, | Me encargué del traspaso del documento a formato markdown, asumiendo un rol fundamental en la fase de presentación final. Esto implicó adaptar el contenido a un formato limpio, accesible y profesional, asegurando que todo estuviera correctamente estructurado para su publicación. Este trabajo fue clave para garantizar la claridad del entregable, facilitando su revisión, distribución y lectura. Mi liderazgo se evidenció en la atención al detalle y en la preparación del proyecto para su entrega formal. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | *Binda Arbañil, Marcelo Alejandro* | Durante el Sprint 4, me enfoqué en coordinar con el equipo para la elaboración del documento de entrega, asegurando que cada sección reflejara correctamente el trabajo de todos. Fomenté un espacio de revisión colaborativa donde cada integrante pudo aportar ideas y sugerencias, lo que permitió una integración fluida de contenidos y un documento final sólido, alineado con nuestros objetivos comunes. |
|  | *Castillo Garay, Ainhoa Lucía* | Mi participación en el desarrollo del módulo “Mis voluntarios” se dio en constante comunicación con mis compañeros, asegurando que la funcionalidad respondiera a las necesidades del sistema general. Propicié instancias de apoyo y feedback que ayudaron a mantener un flujo de trabajo colaborativo, cumpliendo con nuestras metas técnicas sin perder de vista la experiencia del usuario final. |
|  | *Martel Andrade, Cassius Estefano* | Durante este sprint, trabajé activamente para que los módulos bajo mi liderazgo se integraran sin fricciones con el resto del sistema. Promoví sesiones de revisión técnica con mis compañeros, donde definimos prioridades, solucionamos bugs en conjunto y nos apoyamos para cumplir con los plazos establecidos. La planificación compartida fue clave para alcanzar nuestras metas. |
|  | *Nakamurakare Teruya, Alex Tomio* | Fomenté un entorno de comunicación abierta mientras desarrollaba los módulos de calendario y voluntarios inscritos. Coordiné con mis compañeros para alinear los endpoints necesarios y asegurar la coherencia de los datos, lo que nos permitió avanzar de forma coordinada y minimizar conflictos durante la integración. Cada decisión se discutió en equipo, manteniendo nuestros objetivos bien definidos. |
|  | *Ortiz Alarcón, Víctor Nicolás* | Mi enfoque durante el Sprint 4 fue apoyar la integración técnica de funcionalidades en conjunto con el equipo, ofreciendo soluciones rápidas a los obstáculos que surgían. Ayudé a organizar y revisar tareas para que cada módulo estuviera alineado con el diseño general del sistema. La planificación compartida y la colaboración constante fueron claves para lograr entregables de calidad. |
|  | *Galván Cerrón, George Aldo* | Encargado del traspaso del documento a markdown, mantuve una comunicación activa con los responsables de cada sección para asegurar que el formato final representara fielmente el trabajo del equipo. Coordiné revisiones y aseguré la uniformidad en el estilo, lo que permitió entregar un producto claro, ordenado y coherente con los objetivos del sprint, reflejando nuestro esfuerzo colectivo. |
